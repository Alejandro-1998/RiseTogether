<x-layouts.app>
    ...
    <main class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <section class="relative isolate">
            ...
            <div
                ...
                <div class="p-8 sm:p-10">
                    <div class="mb-6">
                        <p class="text-xs uppercase tracking-[0.18em] text-[#9c7049] dark:text-[#a18a7a]">Acceso</p>
                        <h1 class="mt-2 text-3xl font-black tracking-tight">Iniciar sesión</h1>
                    ...
                    <form method="post" action="/login" class="space-y-5">
                        ...
                        <p class="text-center text-sm text-[#9c7049] dark:text-[#a18a7a]">
                            ...
                            <a href="/register" class="font-bold text-[#f2780d] hover:opacity-80">Crea una</a>
                        </p>
                    </form>
                </div>
