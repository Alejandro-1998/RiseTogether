        ...
        <nav className="flex items-center justify-between gap-4" aria-label="Primary">
          ...
          <div className="flex flex-1 items-center justify-end gap-2">
            ...
            <button
              ...
              className="xl:hidden flex h-10 items-center justify-center gap-2 rounded-lg bg-[#f4ede7] px-2.5 text-sm font-bold text-[#1c140d] dark:bg-[#2a2017] dark:text-[#fcfaf8]"
            >
